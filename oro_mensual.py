"""
Análisis de Fat Tails en los Precios del Oro (Precios Mensuales)
...
def imprimir_resultados(resultados):
    ...
    """
    print("\n" + "="*70)
    print("ANÁLISIS DE FAT TAILS - RETORNOS DEL ORO (PRECIOS MENSUALES)")
    print("="*70)
...
def crear_visualizaciones(retornos_limpios, resultados):
    ...
    carpeta_salida = f"analisis_oro_preciosmensuales_{fecha_hora}"
...
def main():
    ...
    print("="*70)
    print("ANÁLISIS DE FAT TAILS EN PRECIOS DEL ORO (PRECIOS MENSUALES)")
    print("="*70)

    # Cambiar a archivo CSV
    archivo = "CMO-Historical-Data-Monthly.csv"
